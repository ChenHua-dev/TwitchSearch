...
public class TwitchClient {
    private static final String TOKEN = "Bearer qitgesyuetqy34snqt2to5xilc5zzm";
    private static final String CLIENT_ID = "czqm8wrzadtisauebpe9ljsy30fync";
    private static final String TOP_GAME_URL = "https://api.twitch.tv/helix/games/top?first=%s";
    private static final String GAME_SEARCH_URL_TEMPLATE = "https://api.twitch.tv/helix/games?name=%s";
    private static final int DEFAULT_GAME_LIMIT = 20;
    // newly added: 6/5/2021
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        ResponseHandler<String> responseHandler = response -> {
            ...
            if (responseCode != 200) {
                ...
                throw new TwitchException("Fail to get result from Twitch API: " +
                        response.getStatusLine().getReasonPhrase());
            }
            HttpEntity entity = response.getEntity();
            if (entity == null) {
                throw new TwitchException("Fail to get result from Twitch API: failed to get entity");
            }
        ...
        // try with resources
        try (CloseableHttpClient httpClient = HttpClients.createDefault()){ // (CloseableHttpClient httpClient = HttpClients.createDefault()) //
            // Define the HTTP request, TOKEN and
            // CLIENT_ID are used for user authentication on Twitch backend
    ...
    private String buildSearchURL(String url, String gameId, int limit) throws TwitchException {
        ...
        String finalUrl = String.format(url, gameId, limit);
//        System.out.println(finalUrl);
    ...
    public Map<String, List<Item>> searchItems(String gameId, int limit) throws TwitchException {
        ...
        Map<String, List<Item>> itemMap = new HashMap<>();
        for (ItemType type : ItemType.values()) {
            itemMap.put(type.toString(), searchByType(gameId, type, limit));
        }
        return itemMap;
    }
